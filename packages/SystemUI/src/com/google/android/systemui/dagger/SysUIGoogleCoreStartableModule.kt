...
abstract class SysUIGoogleCoreStartableModule {
    ...
    abstract fun bindKeyguardBiometricLockoutLogger(sysui: KeyguardBiometricLockoutLogger): CoreStartable
    ...
    abstract fun bindThemeOverlayController(sysui: ThemeOverlayControllerGoogle): CoreStartable
